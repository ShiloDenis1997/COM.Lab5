========================================================================
    ACTIVE TEMPLATE LIBRARY : lab5 Project Overview
========================================================================

AppWizard has created this lab5 project for you to use as the starting point for
...
lab5.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (lab5.h)
        GUID definitions                                (lab5_i.c)
        A type library                                  (lab5.tlb)
        Marshaling code                                 (lab5_p.c and dlldata.c)

lab5.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in lab5.idl. It will be regenerated by MIDL during compilation.
...
lab5ps.vcxproj
	...
	dlldata.c, lab5_i.c and lab5_p.c which are required
	to build the proxy/stub DLL.

lab5ps.vcxproj.filters
